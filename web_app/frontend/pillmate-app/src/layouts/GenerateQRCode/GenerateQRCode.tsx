...
export const GenerateQRCode = () => {
  ...
  const [addtionalAdvice, setAdditionalAdvice] = useState(
  ...
  const [wrongFormatDossagePerTake, setWrongFormatDossagePerTake] =
    useState(false);
      ...
      if (
        ...
        if (user !== null) {
          user.providerData.forEach(async (profile) => {
            ...
            const qrCode: QRCodeModel = new QRCodeModel(
              "",
              profile.displayName!,
              ...
              tmpEvery,
              timeOfTaken,
              gmtsDate.toISOString(),
              gmtsLocalDate.toISOString(),
              conditionOfUse,
              addtionalAdvice,
              parseInt(amountOfMeds),
              250,
              adverseDrugReaction,
              dosageForm,
              genericName,
  ...
  return (
    <div
      className="d-flex"
      style={{ height: "100vh", width: "100vw", marginRight: "1px" }}
    >
      {loadingModal ? (
        <div
          ...
          aria-hidden="true"
          style={{ fontFamily: "LINESeedSansTHRegular" }}
        >
          <div
              ...
              <div className="modal-body">
                ...
                >
                    ...
                    <div>
                      {imageID !== "" ? (
                        <div ref={componentRef}>
                          <img
                            src={
                              process.env.PUBLIC_URL + `/images/${imageID}.png`
                            }
                            id="myimg"
                          />
                        </div>
                  ...
                  <div className="mt-2">
                    ...
                    <div
                      className="mt-2"
                      style={{ fontFamily: "LINESeedSansTHBold" }}
                    >
                      รายละเอียด
                    </div>
                    <hr style={{ width: "100%" }} />
                    ...
                    <div>
                      รับประทานยา{takeMedWhen === "..." ? "" : takeMedWhen}{" "}
                      ครั้งละ {dosagePerTake} {unit}
                    </div>
                    <div>
                      วันละ {timePerDay} ครั้ง{" "}
                      {takeMedWhen === "..."
                        ? `ทุกๆ ${every}`
                        : `${timeOfTakenn}`}
                    </div>
      ...
      <div
        style={{
          width: "38vw",
          background: "#FFFFFF",
          boxShadow: "2px 346px rgba(119, 119, 119, 0.25)",
          paddingTop: "3.5%",
        }}
      >
        <div className="d-flex gap-3">
          <img
            ...
            style={{ width: "140px", height: "140px", marginLeft: "10%" }}
          />
          <div>
            ...
            <div className="d-flex mt-3">
              ...
              <div
                style={{
                  fontSize: "18px",
                  fontFamily: "LINESeedSansENRegular",
                }}
              >
                {tradeName}
              </div>
      ...
      >
        ...
        <div
          className="mt-1"
          style={{ marginLeft: "1%", fontFamily: "LINESeedSansTHRegular" }}
        >
          <div
          ...
          >
            <div style={{ fontSize: "14px", color: "#757575" }}>Drug list</div>
          ...
          <form onSubmit={createQRCode} style={{ width: "39vw" }}>
                ...
                <div className="d-flex">
                  {dosageClick ? (
                    <input
                      ...
                      onBlur={handleDosageClickNotFocus}
                      className="form-control form-control-clicked"
                      placeholder="จำนวน"
                      name="dosagePerTake"
                      required
                      onChange={(e) => handleDosagePerTake(e)}
                      value={dosagePerTake}
                      style={{
                        width: "9vw",
                        height: "46px",
                      ...
                      style={
                        dosageClick
                          ? {
                              ...
                              borderColor: "#1AB48D",
                              boxShadow:
                                "0 0 0 0.2rem rgba(213, 236, 230, 0.75)",
              ...
              <div>
                ...
                {timesPerDayFocus ? (
                  <div className="d-flex">
                    <input
                      type="text"
                      onClick={handleTimesPerDayFocus}
                      ...
                      name="dosagePerTake"
                      required
                      onChange={(e) => handleTimesPerDay(e)}
                      value={timePerDay}
                      style={{
                        width: "11vw",
                        height: "46px",
                    ...
                    />
                    <div
                      className="d-flex align-items-center justify-content-center form-control form-control-clicked"
                      style={{
                        backgroundColor: "white",
                        width: "3vw",
            ...
            <div
              className={
                wrongFormatDossagePerTake || wrongFormatTimesPerDay
                  ? "d-flex justify-content-between align-self-end"
                  : "d-flex justify-content-between align-self-end mt-4"
              }
            >
              <div>
                <label className="form-label">
                ...
                <div className="dropdown">
                  <button
                    className="btn"
                    onClick={handleTakeMedWhenFocus}
                    onBlur={handleTakeMedWhenNotFocus}
                    type="button"
                    id="dropdownMenuButton1"
                    data-bs-toggle="dropdown"
                    style={
                      takeMedWhenClick
                        ? {
                            borderColor: "#1AB48D",
                            boxShadow: "0 0 0 0.2rem rgba(213, 236, 230, 0.75)",
                            backgroundColor: "white",
                            width: "14vw",
                            height: "46px",
                          }
              ...
              <div className="align-self-end">หรือ</div>
              <div>
                <label className="form-label">
                  <div className="d-flex">
                    <div style={{ fontSize: "16px", color: "#000000" }}>
                ...
                <div className="dropdown">
                  <button
                    className="btn"
                    onClick={handleEveryFocus}
                    onBlur={handleEveryNotFocus}
                    type="button"
                    id="dropdownMenuButton1"
                    data-bs-toggle="dropdown"
                    style={
            ...
            <div className="d-flex justify-content-between align-self-end mt-4">
              <div>
                ...
                <div className="d-flex gap-2">
                  {morning ? (
                    ...
                    >
                      <div className="d-flex justify-content-center">เช้า</div>
                    </button>
                  ) : (
                    <button
                      className="btn"
                  ...
                  {evening ? (
                    ...
                    >
                      <div className="d-flex justify-content-center">เย็น</div>
                    </button>
                  ) : (
                    <button
                      className="btn"
              ...
              <div>
                ...
                <input
                  ...
                  name="dosagePerTake"
                  required
                  onChange={(e) => handleExpiredDate(e)}
                  value={expiredDate}
                  style={{ width: "14vw", height: "46px" }}
                />
                {wrongFormatExpiredDate ? (
                  <div className="d-flex gap-1 align-items-center mt-2">
                    <div className="d-flex align-items-center">
                      <IoCloseCircleOutline color="red" />
                    </div>
            ...
            <div
              className={
                wrongFormatExpiredDate
                  ? "d-flex justify-content-start align-self-end"
                  : "d-flex justify-content-start align-self-end mt-4"
              }
            >
              <div>
                <label className="form-label">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="เช่น ลดคลื่นไส้อาเจียน"
                  aria-label="Text input with dropdown button"
                  name="dosagePerTake"
                  required
                  onChange={(e) => setConditionOfUse(e.target.value)}
                  value={conditionOfUse}
                  style={{ width: "39vw", height: "46px" }}
                />
              </div>
            </div>
            ...
            <div className="d-flex justify-content-start align-self-end mt-4">
              <div>
                ...
                <div className="dropdown">
                  <button
                    className="btn"
                    onClick={handleAddtionalAdviceFocus}
                    onBlur={handleAddtionalAdviceNotFocus}
                    type="button"
                    id="dropdownMenuButton1"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                    style={
                      additionalAdviceClick
                        ? {
                            borderColor: "#1AB48D",
                            boxShadow: "0 0 0 0.2rem rgba(213, 236, 230, 0.75)",
                            backgroundColor: "white",
                  ...
                  <ReturnAdditionalAdvice
                    handleAdditionalAdvice={handleAddtionalAdvice}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-start align-self-end mt-4">
              <div>
                ...
                <input
                  ...
                  required
                  onChange={(e) => setAdverseDrugReaction(e.target.value)}
                  value={adverseDrugReaction}
                  style={{ width: "39vw", height: "46px" }}
                />
              </div>
            </div>
            ...
            <div className="d-flex justify-content-between mt-4">
              <div>
                ...
                <div className="d-flex">
                  {unitAmountClick ? (
                    <input
                      type="text"
                      onClick={handleUnitAmountClick}
                      onBlur={handleUnitAmountClickNotFocus}
                      className="form-control form-control-clicked"
                      placeholder="จำนวน"
                      name="dosagePerTake"
                      required
                      onChange={(e) => handleAmountOfMeds(e)}
                      value={amountOfMeds}
                      style={{
                        width: "9vw",
                        height: "46px",
              ...
              <div className="align-self-end">
                <button
                  ...
                  style={{
                    width: "10vw",
                    backgroundColor: "#1AB48D",
                    height: "46px",
                  }}
                >
                  <div
                    className="d-flex justify-content-center"
                    style={{ fontFamily: "LINESeedSansENBold", color: "white" }}
                  >
                    Generate QR
                  </div>
                </button>
