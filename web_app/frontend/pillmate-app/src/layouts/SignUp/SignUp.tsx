...
export const SignUp = () => {
    ...
    const [ pharmacy, setPharmacy ] = useState<PharmacyModel>(new PharmacyModel());
    ...
    return(
        ...
        <div className='d-flex justify-content-between' style={{height:'90vh', width: '100vw'}}>
            ...
            {step == 0 ? <CreateAccount handlePharmacy={handlePharmacy} handleStep={handleStep} />: step == 1 ? <AddressInfo handlePharmacy={handlePharmacy} handleStep={handleStep}  pharmacy={pharmacy}/>: <PharmacyInfo handlePharmacy={handlePharmacy} handleStep={handleStep} pharmacy={pharmacy} />}
            </div>
